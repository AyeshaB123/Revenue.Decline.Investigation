...
SELECT
	a.Year,
	a.[Total Revenue] - a.[Prev Total Revenue] AS [Filtered Revenue Change],
	b.[Total_Revenue] - b.[Prev Total Revenue] AS [Total Revenue Change],
	CAST(
		(a.[Total Revenue] - a.[Prev Total Revenue]) * 100.0 / (b.[Total_Revenue] - b.[Prev Total Revenue]) AS DECIMAL(8, 2)
		) AS [%Revenue Recovery]
...
SELECT
	a.Year,
	a.[Total Quantity Sold] - a.[Prev Quantity Sold] AS [Filtered Quantity Change],
	b.[Total_Quantity_Sold] - b.[Prev Quantity Sold] AS [Total Quantity Change],
	CAST(
		(a.[Total Quantity Sold] - a.[Prev Quantity Sold]) * 100.0 / (b.[Total_Quantity_Sold] - b.[Prev Quantity Sold]) AS DECIMAL(8, 2)
		) AS [%Quantity Recovery]
